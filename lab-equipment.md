...
&nbsp;&nbsp;&nbsp;&nbsp;<span style="display: inline-block; transform: rotate(0deg);">→</span> <strong>Gurobi Optimizer & IPOPT</strong> — large-scale mathematical and nonlinear optimization <br>
...
&nbsp;&nbsp;&nbsp;&nbsp;<span style="display: inline-block; transform: rotate(0deg);">→</span> <strong>CUDA</strong> — GPU-accelerated computing and parallel optimization
<hr style="margin: 20px 0;">
